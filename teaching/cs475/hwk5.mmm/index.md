...
8. You must output the time taken, in seconds, for the calculation to take place. To do this, you should use the `rtclock()` function that is provided to you. When running in parallel mode, you should also show the **speedup** over the sequential version, defined $$Time_{sequential} / Time_{parallel}$$. If you did this right, you should experience significant speedup, since matrix multiplication is highly parallelizable.
