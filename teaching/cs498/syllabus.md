...
#### Course Materials
This is a course for the planning and design of their capstone projects. Students will be expected to identify relevant background readings, documentation, and tools on their own.
...
1. Initial Project document, including the following sections:
    - Problem Statement
    - Stakeholders
