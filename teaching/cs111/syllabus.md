...
#### Prerequisites
CS110, ART 288, DATA 160 with a grade of C- or higher.
...
- 2D Arrays
- Elementary complexity analysis (e.g., searching, sorting)
- Recursion
- File handling
- Object inheritance, constructor chaining, and polymorphism
- Abstract classes, interfaces, and implementations
- Exception handling
...
- Construct and use class hierarchies
- Develop modular programs using interfaces and abstraction
- Use recursion to solve computational problems
- Analyze algorithmic efficiency at an elementary level
- Manipulate arrays and 2D arrays
- Implement file handling for data-driven programs
- Develop programs that can handle runtime errors
- Work effectively in a structured lab setting
