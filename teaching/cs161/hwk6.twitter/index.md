...
| `boolean equalsIgnoreCase(String other)`    | Compares this String to another String, ignoring case considerations                                                          |
| `int indexOf(String str)`                   | Returns the index within this string of the first occurrence of the specified substring                                       |
| `int length()`                              | Returns the length of this string                                                                                             |
| `String replace(String target, String rep)` | Returns a string which has replaced each substring that matches the targeted sequence with the specified replacement sequence |
