let days = {
  ...
  lectures: [
    ...
    "Read: <a href='https://drive.google.com/open?id=1RsmCUeXz9TjIV1PdHgfb-P3drY0smJaz'>Abstract Class and Interface</a>" + "<br/>" + 
      ...
      "Code-Along (Mon): <a href='https://drive.google.com/open?id=1t2xCKIeetcOfAOL_IE82h9luCTUe7IlH'>ShapeManager</a>" + "<br>" +
      "Code-Along (Wed): <a href='https://drive.google.com/open?id=1Voe6PWdSiu667Tk_j36droAiC2CXx5Ij'>UniversalRemote</a>",
    // wk 4
...
const schedule = new CourseCalendar("8/31/2026", days, MWRF);
